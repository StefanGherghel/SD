...
class BidderMicroservice {
    ...
    private var necessaryMessageSocket: Socket
    ...
    init {
        try {
            ...
            necessaryMessageSocket = Socket(AUCTIONEER_HOST, NECESSARYMESSAGE_PORT)
            println("M-am conectat la NecessaryMessage!")
    ...
    private fun bid() {
        ...
        necessaryMessageSocket.getOutputStream().write(serializedMessage)
