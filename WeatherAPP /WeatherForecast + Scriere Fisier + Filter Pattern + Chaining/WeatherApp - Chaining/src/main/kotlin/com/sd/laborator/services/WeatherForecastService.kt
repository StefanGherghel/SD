...
@Service
class WeatherForecastService (private val timeService: TimeService, private val dataLoggerService: DataLoggerService) : WeatherForecastInterface {
    override fun getForecastData(locationId: Int): WeatherForecastData? {
        if (-1 != locationId){
            ...
            dataLoggerService.logData(weatherForecastData)
