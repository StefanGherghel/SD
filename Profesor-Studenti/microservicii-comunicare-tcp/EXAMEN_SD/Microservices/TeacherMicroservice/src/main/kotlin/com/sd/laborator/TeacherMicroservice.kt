...
class TeacherMicroservice {
    ...
    init {
        val databaseLines: List<String> = File("/Users/stef/Desktop/microservicii-comunicare-tcp/EXAMEN_SD/Microservices/TeacherMicroservice/questions_database.txt").readLines()
